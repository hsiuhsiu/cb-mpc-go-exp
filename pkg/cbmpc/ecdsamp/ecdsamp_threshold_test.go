...
// TestECDSAMPThresholdDKG_ORNode mirrors ReconstructPubAdditiveShares_ORNode from test_ec_dkg.cpp
// Access structure: OR(p0, AND(p1, THRESHOLD[1](p2, p3)))
// DKG quorum: {p1, p3} (indices 1, 3)
func TestECDSAMPThresholdDKG_ORNode(t *testing.T) {
...
// TestECDSAMPThresholdDKG_Threshold2of3 mirrors ReconstructPubAdditiveShares_Threshold2of3 from test_ec_dkg.cpp
// Access structure: THRESHOLD[2](p0, p1, p2)
// DKG quorum: {p0, p2} (indices 0, 2)
func TestECDSAMPThresholdDKG_Threshold2of3(t *testing.T) {
	ctx, cancel := context.WithTimeout(context.Background(), 15*time.Second)
	defer cancel()
...
// TestECDSAMPThresholdDKG_ThresholdNofN_ANDEquivalent mirrors ReconstructPubAdditiveShares_ThresholdNofN_ANDEquivalent
// Access structure: THRESHOLD[3](p0, p1, p2) - equivalent to AND since all parties required
// DKG quorum: {p0, p1, p2} (indices 0, 1, 2)
func TestECDSAMPThresholdDKG_ThresholdNofN_ANDEquivalent(t *testing.T) {
	ctx, cancel := context.WithTimeout(context.Background(), 15*time.Second)
	defer cancel()
...
// TestECDSAMPThresholdDKG_Threshold3of4_LargerLeaves mirrors ReconstructPubAdditiveShares_Threshold3of4_LargerLeaves
// Access structure: THRESHOLD[3](p0, p1, p2, p3)
// DKG quorum: {p0, p1, p2} (indices 0, 1, 2)
func TestECDSAMPThresholdDKG_Threshold3of4_LargerLeaves(t *testing.T) {
	ctx, cancel := context.WithTimeout(context.Background(), 15*time.Second)
	defer cancel()
...
// TestECDSAMPThresholdRefresh tests threshold refresh following DKG
func TestECDSAMPThresholdRefresh(t *testing.T) {
	...
	for i := 0; i < nParties; i++ {
		...
		go func(partyID int) {
			...
			result, err := ecdsamp.ThresholdRefresh(ctx, job, &ecdsamp.ThresholdRefreshParams{
